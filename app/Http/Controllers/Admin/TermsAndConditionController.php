...
class TermsAndConditionController extends Controller
{
    ...
    public function __construct(){
        $this->path = 'trams-and-conditions';
        $this->table = 'terms_and_conditions';
    }
    public function index()
    {
        return HelperClass::resourceDataView(TermsAndCondition::query(), ['title', 'serial', /* 'description' */], null, $this->path);
    }
