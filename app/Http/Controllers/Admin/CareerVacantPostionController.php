...
use App\Models\CareerVacantPostion;
use Illuminate\Http\Request;

class CareerVacantPostionController extends Controller
{
    // Display a listing of the resource.
    public $path, $table, $model;
    public function __construct(){
        $this->path = [
            'asset'=> 'media/position/',
            'view'=> 'dynamic-content-upload-page',
            'route'=> 'career-vacant-postion',
        ];
        $this->table = 'career_vacant_postions';
        $this->model = CareerVacantPostion::class;
     }
    ...
    { 
        ...
        $create = [
            ...
            ['label'=> 'Image', 'name'=> 'image', 'type'=> 'file', 'placeholder'=> 1, 'value'=> "0", 'options'=> '(600x360)'],
    ...
    public function index() 
    {
        ...
        return HelperClass::resourceDataView($this->model::query(), [ 'serial','title'], ['image'], $this->path, $resources);
    }
    ...
    public function store(Request $request)
    {
        ...
        $resources = $this->resources('index');
        return HelperClass::resourceDataStore($this->table, $request, ['serial','title'], ['image'], $this->path['asset'], $this->path, null, $resources);
    }
    ...
    {
        $resources = $this->resources('index');
        return HelperClass::resourceDataUpdate($this->table, $id, $request, ['serial','title'], ['image'], $this->path['asset'], $this->path, null, $resources);
    }
