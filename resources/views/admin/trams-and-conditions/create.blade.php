...
<div class="row g-3">
    <div class="col-12">
        <form action="{{ Route('admin.trams-and-conditions.store') }}" method="POST" enctype="multipart/form-data" id="trams-and-conditions-form">
            @csrf
            <div class="card">
                <div class="card-header px-3 py-2">
                    <div class="d-flex justify-content-between align-items-center">
                        <h6 class="h6 mb-0 text-uppercase">Add Trams And Conditions</h6>
                        <a href="{{ Route('admin.trams-and-conditions.index') }}" class="btn btn-primary btn-sm text-uppercase">
                            Go Back
                        </a>
                    </div>
                </div>
                <div class="card-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description" id="description" class="description" cols="30"
