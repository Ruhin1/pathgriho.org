export const arrowChildSvg =
  '<span class="fill-slate-100 group-[child:hover]:-rotate-90 rotate-90 duration-300"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" width="18" height="18"> <path d="M41 288h238c21.4 0 32.1 25.9 17 41L177 448c-9.4 9.4-24.6 9.4-33.9 0L24 329c-15.1-15.1-4.4-41 17-41z" /></svg></span>';
...
export const navMenus = [
  ...
  },
  {
    ...
    href: "#",
    child: [
      { id: 1, name: "Activity Reports", href: "#", children: [] },
      { id: 2, name: "Audit Reports", href: "#", children: [] },
      { id: 3, name: "Stickers and Banners", href: "#", children: [] },
      { id: 4, name: "Monthly Magazine", href: "#", children: [] },
      { id: 5, name: "Others Document", href: "#", children: [] },
    ],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    href: "#",
    child: [
      { id: 1, name: "Blogs", href: "./blog.html", children: [] },
  ...
  },
  {
    ...
    href: "#",
    child: [
      { id: 1, name: "Our Store", href: "./book-store.html", children: [] },
      {
        id: 1,
        name: "Book Details",
  ...
  },
  {
    ...
    child: [
      ...
      },
      {
        ...
        href: "#",
        children: [
          { id: 1, name: "Become e Volunteer", href: "#" },
          { id: 2, name: "Our Partners", href: "./team-gallery.html" },
          { id: 3, name: "Our Mission", href: "#" },
          { id: 4, name: "Our Vision", href: "#" },
          { id: 5, name: "Career", href: "#" },
        ],
      },
...
export const headerMenus = navMenus
  .sort((menuA, menuB) => menuA.id - menuB.id)
  .map(
    (menus) => `
...
export const header = `<nav class="fixed top-0 left-0 bg-slate-200 px-2.5 w-full text-slate-700 z-40">
